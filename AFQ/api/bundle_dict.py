...
def default18_bd():
    ...
    return BundleDict({
        ...
        'Left Cingulum': {'cross_midline': False,
        ...
        'Right Cingulum': {'cross_midline': False,
        ...
        'Left Inferior Fronto-occipital': {'cross_midline': False,
        ...
        'Right Inferior Longitudinal': {'cross_midline': False,
        ...
        'Left Superior Longitudinal': {'cross_midline': False,
        ...
        'Right Superior Longitudinal': {'cross_midline': False,
...
def baby_bd():
    ...
    return BundleDict({
        ...
        'Right Inferior Longitudinal': {'cross_midline': False,
                                        ...
                                        'prob_map': templates['ILF_R_prob_map'],
                                        'mahal': {'distance_threshold': 4}},
        'Left Middle Longitudinal': {'cross_midline': False,
                                     ...
                                     'mahal': {'distance_threshold': 4}},
        'Right Middle Longitudinal': {'cross_midline': False,
